// Syntax for Level 2: Multiple Search Categories (Optional)
...
// Define a function to obtain an array with the extract the values of the country and store in a variable
var countries = alienData.map(function(countries) {
  return countries.country;
});
  
// Extract unique values from the countries array
const uniqueCountries = [...new Set(countries)]
//console.log(uniqueCountries);


// Define a function to obtain an array with the extract the values of the city and store in a variable
var cities = alienData.map(function(cities) {
  return cities.city;
});
  
// Extract unique values from the cities array
const uniqueCities = [...new Set(cities)]
//console.log(uniqueCities);

// Define a function to obtain an array with the extract the values of the state and store in a variable
var states = alienData.map(function(states) {
  return states.state;
});
...
// Define a function to obtain an array with the extract the values of the shapes and store in a variable
var shapes = alienData.map(function(shapes) {
  return shapes.shape;
});
...
function filterData(){
    ...
    // Extract the value from the variables entered in the filter fields and make the entry lower case for the string fields
    ...
    // Apply the conditions for filtering the data and assign it to a variable (including combinations of cases where the filter might be blank)
    var filteredData = alienData.filter(function(recorded){
